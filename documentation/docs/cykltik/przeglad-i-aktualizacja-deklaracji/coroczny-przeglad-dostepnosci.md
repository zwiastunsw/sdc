...
- [Szablon raportu samooceny dostępności (HTML)](/cykltik/przeglad-i-aktualizacja-deklaracji/raport-samooceny-dostepnosci-szablon.html){download}
- [Dowód samooceny w Deklaracji dostępności (HTML)](/cykltik/przeglad-i-aktualizacja-deklaracji/dowod-samooceny-dynamiczny-przyklad.html){download}
