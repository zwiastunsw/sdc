...
Analiza zakresu rozpoznania jest wykonywana zawsze wtedy, gdy organizacja potrzebuje ustalić, jak szeroka, aktualna i wiarygodna jest posiadana wiedza.

Posiadanie wyników ocen lub informacji o stwierdzonych problemach nie oznacza, że organizacja dysponuje wystarczającą wiedzą o całym rozwiązaniu. Wyniki mogą dotyczyć jedynie wybranych wymagań, części rozwiązania, procesów użytkownika lub obiektów, a ich aktualność może ulec zmianie w wyniku modyfikacji rozwiązania lub jego otoczenia.
...
- jakie obiekty tworzyły badaną próbę i na ile była ona reprezentatywna;
...
Analiza pełni również istotną rolę w zarządzaniu ryzykiem dostępności, umożliwiając identyfikację obszarów, w których brak wiedzy lub nieaktualne informacje mogą zwiększać prawdopodobieństwo wystąpienia problemów dostępności lub niezgodności. Dzięki temu organizacja może ustalać priorytety działań w sposób proporcjonalny do znaczenia funkcji, procesów i wymagań oraz do poziomu ryzyka.
...
Analizie podlega w szczególności, czy ocenami objęto:

- najczęściej wykorzystywane funkcje;
- najważniejsze procesy użytkownika;
- usługi o największym znaczeniu;
- obiekty, których dotyczą zgłoszenia użytkowników;
- nowe lub istotnie zmienione części rozwiązania;
- obszary, w których ryzyko występowania problemów jest największe.
...
Analizie podlega w szczególności, czy oceny obejmują:

- istotne systemy operacyjne;
- najważniejsze przeglądarki internetowe;
- urządzenia mobilne i komputery;
- różne wielkości ekranów;
- wykorzystywane technologie wspomagające;
- inne środowiska mające znaczenie dla użytkowników rozwiązania.
