...
### 3.1. Przygotowanie przed rozpoczęciem pracy

Przed rozpoczęciem pracy organizacja powinna:

1. Zweryfikować dostępność materiałów przekazywanych nowemu pracownikowi.
2. Przygotować dostępne cyfrowo:
   - umowy,
   - formularze,
   - skierowania,
   - regulaminy,
...
1. Informacje o organizacji w dostępnej formie.
...
1. Zapewniać dostępność szkoleń wstępnych.
...
1. Wyznaczyć osobę wspierającą proces wdrożenia.
2. Umożliwić zgłaszanie problemów i potrzeb związanych z dostępnością.
...
1. Zbierać informacje zwrotne od nowych pracowników.
