---
id: sposoby-angazowania-osob-z-niepelnosprawnosciami
...
Celem dokumentu jest przedstawienie przykładowych sposobów angażowania osób z niepełnosprawnościami w działania związane z planowaniem, oceną, wdrażaniem i doskonaleniem dostępności cyfrowej.
...
- uczestnicy powinni znać cel i zakres działań;
- zgłaszane uwagi powinny być analizowane i wykorzystywane;
...
Najprostszą formą angażowania jest pozyskiwanie opinii poszczególnych pracowników.

Konsultacje mogą dotyczyć:

- problemów napotykanych podczas pracy;
...
Pracownicy mogą uczestniczyć w testowaniu:
...
- modernizacji istniejących systemów;
- aplikacji mobilnych;
- platform edukacyjnych;
- innych technologii wykorzystywanych przez organizację.
...
- zespołach ds. dostępności;
- grupach roboczych;
- zespołach projektowych;
- zespołach przygotowujących procedury i standardy.
...
W obszarze dostępności cyfrowej ERG mogą:

- identyfikować problemy występujące w organizacji;
...
- wspierać rozwój polityk i standardów organizacyjnych.
...
Panel może być wykorzystywany do:
...
Pracownicy z niepełnosprawnościami mogą uczestniczyć w:

- przygotowywaniu materiałów szkoleniowych;
- prowadzeniu szkoleń;
- prezentowaniu doświadczeń użytkowników;
- działaniach budujących świadomość dostępności.
...
Nie ma jednego sposobu angażowania odpowiedniego dla wszystkich organizacji.

Małe organizacje często osiągają dobre rezultaty dzięki konsultacjom indywidualnym i okresowym rozmowom.

Większe organizacje mogą dodatkowo wykorzystywać:
