...
<!-- Brak działań kadrowych mających na celu osiągnięcie dojrzałości w zakresie dostępności cyfrowej w całej organizacji poprzez włączenie osób z niepełnosprawnościami do zasobów kadrowych. Być może prowadzone są pewne nieformalne działania. Brak jakichkolwiek działań związanych z rekrutacją, utrzymaniem lub angażowaniem pracowników z niepełnosprawnościami. (Nie podjęto żadnych wysiłków lub wskazano jedynie pojedyncze działania.) -->
...
<!--
Uznano potrzebę włączenia osób z niepełnosprawnościami do kadry pracowniczej, aby przyczynić się do osiągnięcia dojrzałości w zakresie dostępności cyfrowej w całej organizacji. Rozpoczęto planowanie, ale rekrutacja, utrzymanie i angażowanie osób z niepełnosprawnościami nie są dobrze zorganizowane. Ogłoszenia o naborze zachęcają osoby z niepełnosprawnościami do składania podań. Włączenie osób z niepełnosprawnościami jest wyraźnie określone w politykach i oświadczeniach dotyczących różnorodności i integracji. Wyznaczono osobę odpowiedzialną za ułatwianie i rozwijanie procesu integracji osób z niepełnosprawnościami. Planowane są szkolenia w zakresie integracji osób z niepełnosprawnościami, odpowiednie do stanowiska każdej osoby
-->
...
<!--
Wdrożono plan działania dotyczący włączania osób z niepełnosprawnościami, aby zapewnić dostępność cyfrową. Określono ogólne podejście organizacji do oceny rekrutacji, zatrzymywania, awansu i zaangażowania pracowników. Trwa integracja procesów mających na celu dojrzewanie działań na rzecz włączania osób z niepełnosprawnościami do działań na rzecz dostępności cyfrowej. Nie jest to konsekwentnie wdrażane w całej organizacji. Określono strategiczne stanowiska dla pracowników z niepełnosprawnościami, które pomogą w testowaniu i tworzeniu dostępnych produktów i usług. Prowadzona jest ukierunkowana rekrutacja pracowników z niepełnosprawnościami. Proces rekrutacji jest dostępny. Rozpoczęły się szkolenia w zakresie dostępności, integracji, wiedzy i umiejętności odpowiednie dla stanowiska każdej osoby.
-->
...
<!--
Pracownicy z niepełnosprawnościami są wykorzystywani w całej organizacji w celu osiągnięcia pełnej dojrzałości w zakresie dostępności cyfrowej. W całej organizacji działania związane z zatrudnianiem osób z niepełnosprawnościami są dobrze zdefiniowane, oceniane, korygowane i zintegrowane z działaniami i celami w zakresie dostępności cyfrowej. Pracownicy z niepełnosprawnościami zajmują kluczowe stanowiska decyzyjne i są rozmieszczeni we wszystkich obszarach organizacji, aby zwiększać dostępność w każdym aspekcie działalności. Grupa ds. zasobów pracowniczych osób z niepełnosprawnościami jest wykorzystywana do informowania o decyzjach dotyczących dostępności. Pracownicy z niepełnosprawnościami są angażowani w testowanie dostępności. Pracownicy z są angażowani w tworzenie dostępnych produktów. Pracownicy z niepełnosprawnościami są angażowani w tworzenie dostępnych usług.
-->
