---
id: podrecznik-tworzenie-dostepnych-dokumentow-w-praktyce
title: Tworzenie dostępnych dokumentów w praktyce
sidebar_position: 4
sidebar_label: Tworzenie dokumentów
description: Poradnik tworzenia dostępnych dokumentów
...
- Stosuj **opisowe linki**, np. „[Formularz zgłoszeniowy](https://...)” zamiast „kliknij tutaj”.  
...
- [WCAG 2.1 w skrócie – gov.pl](https://www.gov.pl/web/dostepnosc-cyfrowa)  
- [Microsoft: Accessibility Checker](https://support.microsoft.com/accessibility)  
- [PAC 3 – PDF Accessibility Checker](https://www.access-for-all.ch/en/pdf-lab/pdf-accessibility-checker.html)  
