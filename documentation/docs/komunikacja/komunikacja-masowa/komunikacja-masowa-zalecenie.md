...
6. Organizacja rozwija kompetencje osób stosujących standardy i w szczególności:
   ...
   - zapewnia, tam gdzie jest to możliwe, dostępne szablony, wzorce oraz konfigurację narzędzi wspierającą stosowanie standardów podczas tworzenia treści;
...
| 0.9 | 20.09.2026 | Aktualizacja po recenzji | Uzupełnienie rekomendacji o dostępne szablony, wzorce i konfigurację narzędzi wspierającą stosowanie standardów. |
